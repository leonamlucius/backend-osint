...
def enumerate_env():
    """
    Return a path for the ${pwd}/key.env file.
...
@click.option('-f', '--file', default=enumerate_env(),
              ...
              help="Location of the key.env file, defaults to key.env file in current working directory.")
...
def cli(ctx: click.Context, file: Any, quote: Any, export: Any) -> None:
    """This script is used to set, get or unset values from a key.env file."""
...
@click.option(
    ...
    default=True,
    help="Override variables from the environment file with those from the key.env file.",
)
